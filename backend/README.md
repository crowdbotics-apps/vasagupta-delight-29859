...
## Project Structure
    ...
    ├── vasagupta_delight_29859  # Django project configurations
...
1. Clone this repo and `cd vasagupta_delight_29859`
...
2. Clone this repo and `cd vasagupta_delight_29859`
